...
#define GTK_SAVEBOX(obj)		\
	(G_TYPE_CHECK_INSTANCE_CAST ((obj), GTK_TYPE_SAVEBOX, GtkSavebox))

#define GTK_SAVEBOX_CLASS(klass)	\
	(G_TYPE_CHECK_CLASS_CAST ((klass), GTK_TYPE_SAVEBOX, GtkSaveboxClass))

#define GTK_IS_SAVEBOX(obj) \
	(G_TYPE_CHECK_INSTANCE_TYPE ((obj), GTK_TYPE_SAVEBOX))

#define GTK_IS_SAVEBOX_CLASS(klass)	\
	(G_TYPE_CHECK_CLASS_TYPE ((klass), GTK_TYPE_SAVEBOX))

#define GTK_SAVEBOX_GET_CLASS(obj)	\
	(G_TYPE_INSTANCE_GET_CLASS ((obj), GTK_TYPE_SAVEBOX, GtkSaveboxClass))
